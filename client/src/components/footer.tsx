        ...
        <footer>
            ...
            <div className="flex flex-col mb-8 space-y-2 justify-center items-center h-16 t-primary ani-show">
                ...
                <p className='text-sm text-neutral-500 font-normal link-line text-center'>
                    <span>
                        © 2024 <a className='hover:underline' href="https://caoni.us.kg" target="_blank">Chisato22</a>
                    </span>
                    ...
                    <br/>
                    <a className='hover:underline' href="https://jinx.acea.us.kg" target="_blank"><span className="icon-MOE"/>萌ICP备20240729号</a> | <a className='hover:underline' href="https://caoni.nyc.mn" title="异次元之旅-跃迁-我们一起去萌站成员的星球旅行吧！" target="_blank">异次元之旅</a>
                    <br/>Powered by <a className='hover:underline' href="https://github.com/kakluo/Rin" target="_blank">Rin</a> & <a className='hover:underline' href="https://www.cloudflare.com" target="_blank">Cloudflare</a>
